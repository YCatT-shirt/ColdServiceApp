...
import firebase from '../services/firebase'; // Asegúrate de que la ruta sea la correcta

// Pantallas que quieres mostrar en las pestañas
import MainHomeScreen from './MainHomeScreen';
import ConfigScreen from '../utils/ConfigScreen';
import MensajesScreen from '../utils/Chat';

// Función para cerrar sesión con confirmaciónS
